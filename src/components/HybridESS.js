...
function HybridESSSettings() {
  ...
  const handlePrevious = () => navigate('/hybrid-electricity'); // Navigate to the previous page (Building Parameters & Consumption)
  const handleNext = () => navigate('/hybrid-economic'); // Direct navigation to the next page (Economic Settings)
...
export default HybridESSSettings;
